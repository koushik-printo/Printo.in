<?php
/*
Filename : envelopes.php
Author : Printo - Koushik
Table Name : Nil
Functionality : Dispaly Envelopes ( staic page)
*/
		...
		//print_r($_POST);
			...
			if($err_userName=="" && $err_userdesc=="" && $err_phoneNumber=="" && $err_emailBlank=="" && $err_invalidEmail=="")
			{
					if(is_uploaded_file($_FILES[uploadfile][tmp_name]))
						{
							$orgName=$_FILES[uploadfile][name];
							$na=explode('.',$orgName);
							$orgName=$na[0];
							...
							{
								$fn=$orgName."_".uniqid("").".".$screen_extn;
								$up_folder="uploads/enquiry_files/".$fn;
								$click= "<strong><a href='http://www.printo.in/download.php?f=". $fn ." '>Click here</a></strong> to download uploaded file ";
								move_uploaded_file($_FILES[uploadfile][tmp_name],$up_folder);
							}
						}   //End of file upload validation
					$insert_sql="insert into printo_enqiry(name,phone,email,special_requirement,for_cover,for_inside_pages,type_of_binding,no_of_pages,attach_artwork,enqiry_type,type_of_job,req_date) values('$_POST[name]','$_POST[phone]','$_POST[email]','$_POST[description]','$coverPage','$innerPages','$Binding','$numPages','$fn','e','Documents',now())";
  ...
  <tr>
    <td bgcolor='#eeeeee'><table width='100%' border='0' cellpadding='0' cellspacing='5'>
      ...
      <tr>
        ...
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>Documents</td>
      </tr>
      <tr>
        <td align='right' style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'><strong>Cover Page</strong></td>
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>". $coverPage."</td>
      </tr>
      <tr>
        <td align='right' style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'><strong>Inner Page Type</strong></td>
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>".$innerPages."</td>
      </tr>
	   <tr>
        <td align='right' style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'><strong>Binding</strong></td>
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>".$Binding."</td>
      </tr>
	   <tr>
        <td align='right' style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'><strong>Number of pages </strong></td>
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>".$numPages."</td>
      </tr>
      <tr>
...
$smarty->display('product_documents.tpl');
?>
