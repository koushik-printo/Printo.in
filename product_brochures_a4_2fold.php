			...
			if($err_userName=="" && $err_userdesc=="" && $err_phoneNumber=="" && $err_emailBlank=="" && $err_invalidEmail=="")
			{
				//print print_r($_FILES);
					...
					if(is_uploaded_file($_FILES[uploadfile][tmp_name]))
					  ...
					  $insert_sql="insert into printo_enqiry(name,phone,email,special_requirement,for_inside_pages,additional_finishing,type_of_fold,quantity,attach_artwork,enqiry_type,type_of_job,req_date) values('$_POST[name]','$_POST[phone]','$_POST[email]','$_POST[description]','$paperType','$lamination','$fold','$quantity','$fn','e','2fold A4 Brochures',now())";
  ...
  <tr>
    <td bgcolor='#eeeeee'><table width='100%' border='0' cellpadding='0' cellspacing='5'>
      ...
      <tr>
        ...
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>2 Folds A4 Brochures</td>
      </tr>
      <tr>
      ...
      <tr>
        <td align='right' style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'><strong>Lamination Finishing</strong></td>
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>".$lamination."</td>
      </tr>
	  <tr>
        <td align='right' style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'><strong>Fold</strong></td>
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>".$fold."</td>
      </tr>
	  <tr>
...
$smarty->display('product_brochure_a4_2fold.tpl');
?>
