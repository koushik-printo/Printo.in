...
Table Name : Nil
Functionality : Dispaly Flyers ( staic page)
*/
		...
		//print_r($_POST);
			...
			if($err_userName=="" && $err_userdesc=="" && $err_phoneNumber=="" && $err_emailBlank=="" && $err_invalidEmail=="")
			{
					if(is_uploaded_file($_FILES[uploadfile][tmp_name]))
						...
						$descriptionText=escapeit($userdescription);
						$insert_sql="insert into printo_enqiry(name,phone,email,special_requirement,for_inside_pages,additional_finishing,quantity,attach_artwork,enqiry_type,type_of_job,req_date) values('$_POST[name]','$_POST[phone]','$_POST[email]','$descriptionText','$paperType','$Lamination','$Quantity','$fn','e','Rack Card',now())";
  ...
  <tr>
    <td bgcolor='#eeeeee'><table width='100%' border='0' cellpadding='0' cellspacing='5'>
      ...
      <tr>
        ...
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>Rack Card</td>
      </tr>
      <tr>
...
$smarty->display('product_flyers_a4_rack.tpl');
?>
