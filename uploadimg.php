...
/*	if($width < $cardwidth || $hight < $cardheight)
	...
	if(move_uploaded_file($ftmp,$thumb_)){
	...
	$('#draggable'+gFiles+'_div',window.parent.document).attr('class','drsElement drsMoveHandle');
	$('#draggable'+gFiles+'_text',window.parent.document).css('z-index',0);
...
<label class="cabinet" onClick="cabinetClick()"> 
		 <input type="file" name="image" size="1" onChange="return upload();" onKeyUp="return upload();" style="width: 100px;" class="file" />
