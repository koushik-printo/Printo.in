...
$earvar='<?xml version="1.0" encoding="utf-8"?>';
	...
	for($k=0;$k<count($_REQUEST['draggable_textt']);$k++)
	{
		...
		if($_REQUEST['draggable_textt'][$k]!='' && $extension != "jpg" && $extension != "JPG" && $extension != "jpeg" && $extension != "JPEG" &&  $extension != "gif" && $extension != "GIF" && $extension != "png" && $extension != "PNG")
		{
			$earvar.='<Text ';
		...
		if($_REQUEST['draggable_textt'][$k]!='' && ($extension == "jpg" || $extension == "JPG" || $extension == "jpeg" || $extension == "JPEG" ||  $extension == "gif" || $extension == "GIF" || $extension == "png" || $extension == "PNG"))
		{	
			$logoimgthumb=$_REQUEST['draggable_textt'][$k];

			$logoimg = $_REQUEST['draggable_textt'][$k];
