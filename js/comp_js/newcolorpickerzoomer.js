...
function e(s){if(typeof console!="undefined" && typeof console.debug!="undefined")
{console.log(s)}
...
$(this).addClass("hover").stop().animate({
	...
	'margin-left':'2px','margin-top':'2px',top:'0',left:'0',width:'22px',height:'15px'
...
'margin-left':'5px','margin-top':'5px',width:'17px',height:'10px'

},
d.speedRemove);$(this).find('.title').remove()})}}})(jQuery);/*marginTop:'0',marginLeft:'0',top:'0',left:'0',*/
