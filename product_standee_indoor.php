...
if(isset($_POST[ReqSubmit_x]))
	{
			...
			$err_userdesc=$validation_obj->checkNull($_POST[description],"Enter User Email");
			...
			if($err_userName=="" && $err_userdesc=="" && $err_phoneNumber=="" && $err_emailBlank=="" && $err_invalidEmail=="")
			{
				  ...
				  $insert_sql="insert into printo_enqiry(name,phone,email,special_requirement,for_inside_pages,quantity,attach_artwork,enqiry_type,type_of_job,req_date) values('$_POST[name]','$_POST[phone]','$_POST[email]','$_POST[description]','$paperType','$Quantity','$fn','e','Standee Indoor',now())";
  ...
  <tr>
    <td bgcolor='#eeeeee'><table width='100%' border='0' cellpadding='0' cellspacing='5'>
      ...
      <tr>
        ...
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>Standee Indoor</td>
      </tr>
      <tr>
...
$smarty->display('product_standee_indoor.tpl');
?>
