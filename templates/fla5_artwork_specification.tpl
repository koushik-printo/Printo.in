...
<div class="proUpload"> Ensure at least 5 MM of bleed around your artwork.
                  Keep important text (like phone numbers) within the 'Safe Area' (see template for reference)
                  Colours you see on the screen could vary on print. please ensure your artwork is in CMYK colours to reduce this variance
                  Photographs/Images must be in 300 DPI to avoid pixilation/jagged edges Adobe Illustrator, CorelDraw or PDF are best suited for production If you only have a single page design, we can print  the same on both sides. Alternatively you could add a map or different address/locations of your business behind!<br />
                                    <br />
                                    <div class="prod-infos">
                                      ...
                                      <div class="upld">
                                        ...
                                        <div class="left">
                                          ...
                                          <br />
                                          <div class="corel"><a href="download.php?f=/downloads/templates/fls_artwork_specification.cdr" ><img src="images/corel.png" width="20" height="20" /></a>&nbsp; <a href="downloads/templates/fls_artwork_specification.ai"><img src="images/ai.gif" width="20" height="19" /></a></div>
                                        </div>
                                        <div class="note">
                                          <p class="red">Note: </p>
                                     ...
                                     <!-- <div class="visual-actions" > <a class="btn-blue" href="cart_user_files.php?pid=13" ><span><span>Continue</span></span></a> </div> -->
                                    </div>
                </div>
