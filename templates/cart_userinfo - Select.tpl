...
<div id="base_frame" >
  ...
  <table width="670" border="0" class="form">
    ...
    <tr>
      ...
      <td width="209" valign="top"><input type="text" name="billing_fname" value="{$cur_billing_fname}" onchange="myformchange();" />
        <br />
      ...
      <td width="229" valign="top"><input type="text" class="big" name="billing_lname" value="{$cur_billing_lname}" onchange="myformchange();" />
        <br />
        <span class="red">{if $err_billing_lname ne ''} {$err_billing_lname} {/if}</span></td>
    </tr>
    <tr>
      <td   class="pad-top-3px" align="right" valign="top"><span class="red">*</span>House No :</td>
      <td valign="top"><input type="text" name="billing_address1" value="{$cur_billing_address1}" onchange="myformchange();" />
        <br />
        <span class="red">{if $err_billing_address1 ne ''} {$err_billing_address1} {/if}</span></td>
      <td   class="pad-top-3px" align="right" valign="top"><span class="red">*</span>Street :</td>
      <td valign="top"><input type="text" name="billing_address2" value="{$cur_billing_address2}" onchange="myformchange();" />
        <br />
    ...
    <tr>
      ...
      <td valign="top"><input type="text" name="billing_pincode" value="{$cur_billing_pincode}" /> <!--onchange="getbillingarea(this.value);"-->
        <br />
        <span class="red">{if $err_billing_pincode ne ''} {$err_billing_pincode} {/if}</span></td>
      <td  class="pad-top-3px"  align="right" valign="top"><span class="red">*</span>Area :</td>
      <td valign="top"><div id="txtHint"><input type="text" name="billing_area" value="{$cur_billing_area}" onchange="myformchange();" />
        <br />
    ...
    <tr>
      ...
      <td valign="top"><input type="text" name="billing_city" value="{$cur_billing_city}" onchange="myformchange();" />
        <br />
...
<td valign="top"><select name="billing_state" onchange="myformchange();">
  ...
  <span class="red">{if $err_billing_state ne ''} {$err_billing_state} {/if}</span></td>
    ...
    <tr>
      ...
      <td valign="top"><!--<select class="billing_country">
      ...
      </select>-->India<input type="hidden" name="billing_country" value="India" /></td>
      <td   class="pad-top-3px" align="right" valign="top"><span class="red">*</span>Mobile :</td>
      <td valign="top"><input type="text" name="billing_phone" value="{$cur_billing_phone}" onchange="myformchange();" />
        <br />
  ...
  <table width="670" border="0" class="form">
      ...
      <td colspan="4" align="left"><table width="250" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="35" style="border-top:none">
            <label>
               <input type="checkbox" name="ship" id="ship" value="1" onchange="myformchange();" {if $ship eq '1'} checked {/if}  />
              </label>            </td>
    ...
    <tr>
      <td class="pad-top-3px" width="241" align="right" valign="top"><label for="label"><span class="red">*</span>First Name :</label></td>
      <td width="209" valign="top"><input type="text" name="shipping_fname" value="{$cur_shipping_fname}" />
        <br />
        <span class="red">{if $err_shipping_fname ne ''} {$err_shipping_fname} {/if}</span></td>
      <td class="pad-top-3px" width="241" align="right" valign="top"><span class="red">*</span>Last Name :</td>
      <td width="229" valign="top"><input type="text" class="big" name="shipping_lname" value="{$cur_shipping_lname}" />
        <br />
        <span class="red">{if $err_shipping_lname ne ''} {$err_shipping_lname} {/if}</span></td>
    </tr>
    <tr>
      <td  class="pad-top-3px" align="right" valign="top"><span class="red">*</span>House No :</td>
      <td valign="top"><input type="text" name="shipping_address1" value="{$cur_shipping_address1}" />
        <br />
        <span class="red">{if $err_shipping_address1 ne ''} {$err_shipping_address1} {/if}</span></td>
      <td  class="pad-top-3px"  align="right" valign="top"><span class="red">*</span>Street :</td>
      <td valign="top"><input type="text" name="shipping_address2" value="{$cur_shipping_address2}" />
        <br />
        <span class="red">{if $err_shipping_address2 ne ''} {$err_shipping_address2} {/if}</span></td>
    </tr>
    <tr>
      <td  class="pad-top-3px"  align="right" valign="top"><span class="red">*</span>Postal Code :<span class="red"></span></td>
      <td valign="top"><input type="text" name="shipping_pincode" value="{$cur_shipping_pincode}" /> <!--onchange="getshippingarea(this.value);"-->
        <br />
        <span class="red">{if $err_shipping_pincode ne ''} {$err_shipping_pincode} {/if}</span></td>
      <td  class="pad-top-3px"  align="right" valign="top"><span class="red">*</span>Area :</td>
      <td valign="top"><div id="txtHintShip"><input type="text" name="shipping_area" value="{$cur_shipping_area}" />
        <br />
        <span class="red">{if $err_shipping_area ne ''} {$err_shipping_area} {/if}</span></div></td>
    </tr>
    <tr>
      <td   class="pad-top-3px"  align="right" valign="top"><span class="red">*</span>City :</td>
      <td valign="top"><input type="text" name="shipping_city" value="{$cur_shipping_city}" />
        <br />
        <span class="red">{if $err_shipping_city ne ''} {$err_shipping_city} {/if}</span></td>
      <td   class="pad-top-3px" align="right" valign="top"><span class="red">*</span>State :</td>
      <td valign="top"><select name="shipping_state">
                    <option value="0">Select State</option>
    ...
    <tr>
      <td   class="pad-top-3px" align="right" valign="top"><span class="red">*</span>Country :</td>
      <td valign="top"><!--<select class="shipping_country">
          <option value=""> - Select - </option>
      ...
      </select>-->India<input type="hidden" name="shipping_country" value="India" /></td>
      <td  class="pad-top-3px"  align="right" valign="top"><span class="red">*</span>Mobile :</td>
      <td valign="top"><input type="text" name="shipping_phone" value="{$cur_shipping_phone}" />
        <br />
