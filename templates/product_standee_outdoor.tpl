  ...
  <div id="content_frame" >
        ...
        <div class="breadcrumb">
					<ul>
						...
						<li>Products</li>
						<li class="last"><span>Standee </span>Outdoor </li>
        ...
        <div class="title-box">
          <h2>Standee <span>Outdoor</span></h2>
          <ul class="steps" >
            <li  >
              <label>Step</label>
              <span><span>1</span>
                       ...
                       <tr>
                         <td><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#efefef">
                           ...
                           <tr>
                             ...
                             <td><select name="Media" id="Media" style="width:100%">
                               <option value="Regular" selected="selected">Regular</option>
                               <option value="Korean Flex">Korean Flex</option>
                             </select></td>
                            </tr>
                           <tr>
                             <td>Quantity</td>
