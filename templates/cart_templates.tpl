    					...
    					{if $cur_product_id eq '17'}
                          ...
                          {/if}
                            ...
                            {elseif $cur_product_id eq '16'}
                                        ...
                                        {else}
                                        <li><a style="position:relative; margin-top:22px;" id="{$tempalteFolder}{$tempaltesList[nr].templateimage}" name="pid={$cur_product_id}&tid={$tempaltesList[nr].templateid}&tcid={$cur_tempalte_category_id}&itemid={$current_item_id}"><span><span class="dr">{$tempaltesList[nr].templatebasename}<img src="{$tempalteFolder}{$tempaltesList[nr].templateimage}" border="0"  width="250"  /></span></span></a></li>
                                        {/if}
