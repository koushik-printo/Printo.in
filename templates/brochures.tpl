        ...
        <div class="inner-wrapper" >
          <div class="inner-page-content-l box-style-light-gray" >
            ...
            <div class="prod-infos">
              ...
              <div class="visual-actions" > <!--<a class="btn-blue" href="cart_templates.php?pid=11" ><span><span>Browse Templates</span></span></a> --> <a href="cart_user_files.php?pid=11" class="btn-green upload"><span><span>Order Now</span></span></a><a href="customise-order.php" class="btn-green upload"><span><span>Send Enquiry</span></span></a> </div>
            </div>
