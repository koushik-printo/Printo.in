                     ...
                     <table width="100%" border="0" cellpadding="0" cellspacing="0">
                       <tr>
                         <td><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#efefef">
                           ...
                           <tr>
                             <td><select name="Side" id="Side" style="width:100%">
                             		<option value="single">Single Side</option>
                               		<option value="double">Double Side</option>
                             	</select></td>
                             <td><select name="Lanyards" id="Lanyards" style="width:100%">
                           ...
                           <tr>
                             <td><select name="case" id="case" style="width:100%">
                             		<option value="no">No</option>
                               		<option value="yes">Yes</option>
                             	</select></td>
