...
<div id="base_frame" >
  ...
  <div id="content_frame" >
        ...
        <div class="title-box">
          <h2>Standee <span>Indoor</span> </h2>
          <ul class="steps" >
            <li  >
              <label>Step</label>
              <span><span>1</span>
                         ...
                         <td><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#efefef">
                           ...
                           <tr>
                             <td><select name="paperType" id="paperType" style="width:100%">
                               <option value="Regular">Regular (2' X 5')</option>
                               <option value="Large">Large (3' X 6.5')</option>
                             </select></td>
                    ...
                    <td width="50%" valign="top"><h4>My details</h4>
                      ...
                      <tr>
                        <td height="40"><div class="float-left"><img src="images/icon-artwork-speci.jpg" width="20" height="20" /></div>
                          <div class="float-left"><a href="#" style="float:none; margin:0; padding-left:8px;" onclick="MM_openBrWindow('st_artwork_specification.php','{$Name1}{$Name2}','scrollbars=yes,width=650,height=500')" >Artwork Specification</a></div>
