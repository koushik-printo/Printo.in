...
<div class="proUpload">Give at least 5 MM of bleed around your artwork. Keep important text (like phone numbers) within the 'Safe Area' (see template for reference) Colours you see on the screen could vary on print. please ensure your artwork is in CMYK colours to reduce this variance Photographs/Images must be in 300 DPI to avoid pixilation/jagged edges Adobe Illustrator, CorelDraw or PDF are best suited for production. <br />
                                    <br />
                                    <div class="prod-infos">
                                      ...
                                      <div class="upld">
                                        ...
                                        <div class="left">
                                          <div class="pro"><img src="images/img_envelop-art-area.gif" /></div>
                                          <br />
                                          ...
                                          <br />
                                          <div class="corel"><a href="downloads/templates/envelope/envelope-template.cdr" target="_blank"><img src="images/corel.png" width="20" height="20" /></a>&nbsp; <a href="downloads/templates/envelope/envelope-template.ai" target="_blank"><img src="images/ai.gif" width="20" height="19" /></a></div>
                                        </div>
                                        <div class="note">
                                          <p class="red">Note: </p>
                                      ...
                                      <!--<div class="visual-actions" > <a class="btn-blue" href="cart_user_files.php?pid=10" ><span><span>Continue</span></span></a> </div> -->
                                    </div>
                </div>
