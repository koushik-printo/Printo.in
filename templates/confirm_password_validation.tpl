  ...
  <div id="content_frame" >
			...
			<form name="form1" action="" method="post">
			  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td><h2>Change <span>Your Password</span></h2></td>
                </tr>
                <tr>
                  <td align="center">&nbsp;</td>
                </tr>
                <tr>
                  <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="margin-left:5px;">
                    ...
                    <tr>
                      ...
                      Accept <a href="#" style="text-decoration:none; color:#000;" onclick="MM_openBrWindow('terms_of_use-popup.html','','scrollbars=yes,width=600')">Terms &amp; Conditions.</a></td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                    </tr>
