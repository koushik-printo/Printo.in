  ...
  <div id="content_frame" >
        ...
        <div class="breadcrumb">
					<ul>
						...
						<li>Products</li>
						<li class="last"><span>Brochures</span> A4</li>
                     ...
                     <table width="100%" border="0" cellpadding="0" cellspacing="0">
                       <tr>
                         <td><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#efefef">
                           <tr>
                             <td width="50%">Paper Type</td>
                             <td width="50%">No of Pages</td>
                             </tr>
                           <tr>
                             ...
                             <td><select name="no_of_pages" id="no_of_pages" style="width:100%">
                           ...
                           <tr>
                             ...
                             <td><select name="Lamination" id="Lamination" style="width:100%">
                           ...
                           <tr>
                             <td><select name="Quantity" id="Quantity" style="width:100%">
                    ...
                    <td width="50%" valign="top"><h4>My details</h4>
                      ...
                      <tr>
                        <td height="40"><div class="float-left"><img src="images/icon-artwork-speci.jpg" width="20" height="20" /></div>
                          <div class="float-left"><a href="#" style="float:none; margin:0; padding-left:8px;" onclick="MM_openBrWindow('br_artwork_specification.php','{$Name1}{$Name2}','scrollbars=yes,width=650,height=500')" >Artwork Specification</a></div>
