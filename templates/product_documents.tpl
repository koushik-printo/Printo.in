  ...
  <div id="content_frame" >
        ...
        <div class="breadcrumb">
					<ul>
						...
						<li>Products</li>
						<li class="last">Document printing</li>
                     ...
                     <table width="100%" border="0" cellpadding="0" cellspacing="0">
                       <tr>
                         <td><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#efefef">
                           <tr>
                             <td width="51%">Cover Paper Type</td>
                             <td>Inner Pages Paper Type</td>
                            </tr>
                           <tr>
                             <td><select name="coverPage" id="coverPage" style="width:100%">
                               <option value="300 GSM ">300 GSM </option>
                             </select></td>
                             <td><select name="innerPages" id="innerPages" style="width:100%">
                               <option value="100 GSM">100 GSM</option>
                             </select></td>
                            </tr>
                           <tr>
                             <td>Binding</td>
                             <td>No of Inner Pages</td>
                           </tr>
                           <tr>
                             <td><select name="Binding" id="Binding" style="width:100%">
                               <option value="Saddle-stitching" selected="selected">Saddle-stitching</option>
                               <option value="wire-o binding ">wire-o binding </option>
                               <option value="spiral binding ">spiral binding </option>
                             </select></td>
                             <td><label for="textfield2"></label>
                               <input name="numPages" type="text" id="textfield2" style="width:160px;" value="8" /></td>
                           </tr>
                         </table></td>
                         <td width="30">&nbsp;</td>
                       </tr>
                    ...
                    <td width="50%" valign="top"><h4>My details</h4>
                      ...
                      <tr>
                        <td height="40"><div class="float-left"><img src="images/icon-artwork-speci.jpg" width="20" height="20" /></div>
                          <div class="float-left"><a href="#" style="float:none; margin:0; padding-left:8px;" onclick="MM_openBrWindow('dp_artwork_specification.php','{$Name1}{$Name2}','scrollbars=yes,width=650,height=500')" >Artwork Specification</a></div>
