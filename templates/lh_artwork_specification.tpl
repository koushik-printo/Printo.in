    ...
    position: relative;
                                    ...
                                    <div class="prod-infos">
                                      ...
                                      <div class="upld">
                                        ...
                                        <div class="left">
                                          <div class="pro"> <img src="images/bleed-A4-letterheads.gif" width="225" height="306" /></div>
                                          <br />
                                          ...
                                          <br />
                                          <div class="corel"><a href="download.php?f=/downloads/templates/lh_artwork_specification.cdr"><img src="images/corel.png" width="20" height="20" /></a>&nbsp; <a href="downloads/templates/lh_artwork_specification.ai"><img src="images/ai.gif" width="20" height="19" /></a></div>
                                        </div>
                                        <div class="note">
                                          <p class="red">Note: </p>
