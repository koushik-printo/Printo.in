                         ...
                         <td><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#efefef">
                           ...
                           <tr>
                             <td><select name="select" id="select" style="width:100%">
                               <option value="100 GSM Bond">100 GSM Bond</option>
                             </select></td>
                           ...
                           <tr>
                             <td><select name="select3" id="select3" style="width:100%">
                        ...
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#efefef">
                          <tr>
                            ...
                            <td width="75%"><label for="textfield"></label>
                              <input type="text" name="userName" id="textfield" style="width:80%" /></td>
                          </tr>
                          <tr>
                            <td align="right">Email</td>
                            <td><input type="text" name="userEmail" id="textfield2" style="width:80%"/></td>
                          </tr>
                          <tr>
                            <td width="25%" align="right">Phone No</td>
                            <td><input type="text" name="phoneNumber" id="textfield3" style="width:80%"/></td>
                          </tr>
                          <tr>
