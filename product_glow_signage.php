...
if(isset($_POST[ReqSubmit_x]))
	{
			...
			if($err_userName=="" && $err_userdesc=="" && $err_phoneNumber=="" && $err_emailBlank=="" && $err_invalidEmail=="")
			{
					if(is_uploaded_file($_FILES[uploadfile][tmp_name]))
					 ...
					 $insert_sql="insert into printo_enqiry(name,phone,email,special_requirement,attach_artwork,enqiry_type,type_of_job,req_date) values('$_POST[name]','$_POST[phone]','$_POST[email]','$_POST[description]','$fn','e','Calenders',now())";
  ...
  <tr>
    <td bgcolor='#eeeeee'><table width='100%' border='0' cellpadding='0' cellspacing='5'>
      ...
      <tr>
        ...
        <td style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;'>Glow Signage</td>
      </tr>
      <tr>
...
$smarty->display('product_glow_signage.tpl');
?>
