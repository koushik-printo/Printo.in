...
$order_item_query="insert into order_items(order_id,product_id,template_id,quantity,price,file_id,form_fields,opt_fields,item_image) values('$current_order_id','$product_id','$template_id','$quantity','$price','$file_id','$form_fields','$opt_fields','$item_image')";
...
$message=$ordersutility_obj->getOrderConfirmationMail($current_order_id,$ebs_BillingName,$mail_items,$shipping_charge,$final_price,$shipping_address,$billing_address);
...
$message="New order has been placed, here is the details <br>
   <p>Order ID <br>".$current_order_id."</p>
